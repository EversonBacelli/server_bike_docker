...
function gerar30Bikes() {
    ...
    const aros = [26, 27, 29];
    const img_urls = [
        'https://via.placeholder.com/150/FF0000/FFFFFF?text=Bike+1',
        'https://via.placeholder.com/150/0000FF/FFFFFF?text=Bike+2',
        'https://via.placeholder.com/150/00FF00/FFFFFF?text=Bike+3',
        'https://via.placeholder.com/150/FFFF00/FFFFFF?text=Bike+4',
        'https://via.placeholder.com/150/000000/FFFFFF?text=Bike+5'
    ];
